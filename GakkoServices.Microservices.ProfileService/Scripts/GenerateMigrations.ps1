...
dotnet ef migrations add InitialApplicationMigration --context GakkoServices.Microservices.ProfileService.Data.Contexts.ProfileServiceDbContext -o $applicationDbPath
